module.exports = {
  ...
  rules: {
    ...
    } ], /**dom标签同行最多写6个属性，超过后须换行；换行后的属性，同行最多写1个属性 */
    ...
    '@typescript-eslint/camelcase': 'off', /**允许使用下划线命名变量 */
    '@typescript-eslint/no-this-alias': 'off', /**允许定义this别名 */
    'no-self-assign': 'off', /**允许自己改变自己 */
